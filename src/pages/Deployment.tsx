      ...
      <div className="flex-grow container mx-auto px-4 py-12 max-w-7xl">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-xl text-secondary-600 max-w-4xl mx-auto leading-relaxed">
            Take your ChatAndBuild projects from development to production with our comprehensive deployment guide. Learn how to deploy to various platforms and configure custom domains.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
            ...
            <p className="text-secondary-600">Average deployment time</p>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
              ...
              <div className="space-y-12">
                ...
                <div>
                  ...
                  <p className="text-secondary-600 mb-6">
                    Deploy your ChatAndBuild project instantly with our integrated deployment system. No configuration required.
                  </p>
                  ...
                  <div className="bg-gradient-to-r from-primary-50 to-blue-50 p-6 rounded-lg border border-primary-200 mb-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center text-sm text-secondary-700">
                        ...
                        Click "Deploy" in your ChatAndBuild project
                      </div>
                      <div className="flex items-center text-sm text-secondary-700">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                ...
                <div>
                  ...
                  <p className="text-secondary-600 mb-6">
                    Connect your own domain to your deployed application for a professional appearance.
                  </p>
                ...
                <div>
                  ...
                  <p className="text-secondary-600 mb-6">
                    Deploy to popular hosting platforms with pre-configured settings.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                      ...
                      <p className="text-sm text-secondary-600 mb-4">
                        Perfect for React, Next.js, and static sites with automatic deployments.
                      </p>
                ...
                <div className="bg-red-50 p-6 rounded-lg border border-red-200">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-red-900 mb-2">Deployment failures</h4>
                      <p className="text-sm text-red-800">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-gradient-to-br from-primary-50 to-blue-50 rounded-xl border border-primary-200 p-6">
                ...
                <p className="text-sm text-secondary-600 mb-4">
                  Get assistance with deployment issues or domain configuration.
                </p>
                <div className="space-y-2">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-primary-600 to-blue-600 rounded-2xl p-12 text-white">
            <h2 className="text-3xl font-bold mb-4">Ready to Deploy Your Application?</h2>
            <p className="text-xl mb-8 opacity-90">
              Take your project live with our streamlined deployment process
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button className="px-8 py-3 bg-white text-primary-600 hover:bg-gray-100 rounded-lg font-medium transition-all duration-200 flex items-center justify-center">
                <Rocket className="mr-2 h-5 w-5" /> Deploy Now
              </button>
